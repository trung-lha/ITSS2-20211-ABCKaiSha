<div class="row productList">
    ...
    <div class="col-md-6 col-lg-3 ftco-animate">
        <div class="product">
            <a href="{{ route('product.detail', $product['id']) }}" class="img-prod">
                <img class="img-fluid" src="{{$imageUrl[$key]}}" alt="{{$product['name']}}" style="height: 200px; width: 250px; object-fit: cover;">

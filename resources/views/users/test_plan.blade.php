<style>
    ...
    #form_contact .btn {
        ...
        #form_contact .btn:hover, .btn:active, .btn:focus {
            outline: none; }
...
<div class="container">
  <div class="row">
    <div class="col-12 mt-3">
      <form action="{{route('contact.post')}}" method="POST" id="form_contact" class="bg-white p-5">
        @csrf
        @if ($errors->any())
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-10">
            <select id="plan-choices" name="plan-choices" style="" multiple required>
